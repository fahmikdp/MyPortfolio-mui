    ...
    <Container className="home">
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={2}>
          <Grid item lg={6} md={6} xs={12} sx={{ mt: 1 }} data-aos="fade-right">
            <Typography variant="h3" letterSpacing={0.9} className="home-text">
              Hi, <br /> I am <span>Fahmi</span> <br />
              Front-End Developer
            </Typography>
            <IconButton className="btn-home">
              <Links href="https://github.com/fahmikdp" className="link">
                <GithubLogo sx={{ color: "#08BDBA" }} />
              </Links>
            </IconButton>
            <IconButton className="btn-home">
              <Links href="https://instagram.com/fahmikdp" className="link">
